#tag BuildAutomation
			Begin BuildStepList Linux
				...
				End
				Begin CopyFilesBuildStep CopyResourcesLin
					AppliesTo = 0
					Architecture = 0
					Destination = 1
					Subdirectory = 
				...
				End
				Begin IDEScriptBuildStep SetBuildNumberLin , AppliesTo = 0, Architecture = 0
			...
			Begin BuildStepList Windows
				Begin IDEScriptBuildStep SetBuildNumberWin , AppliesTo = 0, Architecture = 0
					// Set build date version number
					PropertyValue("App.ShortVersion") = PropertyValue("App.NonReleaseVersion")
